defmodule HexerBackendWeb.CoreComponents do
  @moduledoc """
  ...
  def translate_error({msg, opts}) do
    ...
    if count = opts[:count] do
      Gettext.dngettext(HexerBackendWeb.Gettext, "errors", msg, msg, count, opts)
    else
      Gettext.dgettext(HexerBackendWeb.Gettext, "errors", msg, opts)
    end
  end
